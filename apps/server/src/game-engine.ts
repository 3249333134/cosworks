...
interface AuctionLot { lotId:string; sellerAccountId:string; title:string; story:string; assetId:string; imageUrl:string; thumbUrl:string; submittedAt:number; bidHistory:AuctionBid[]; winnerAccountId:string|null; soldPrice:number|null; soldAt:number|null; sold:boolean; reservePrice:number }
