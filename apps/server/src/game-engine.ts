...
interface DrawState { word:string; order:string[]; currentIndex:number; drawing:string|null; drawings:string[]; liveDrawing:string|null; stage:'drawing'|'guessing'|'reveal'; guess:string|null; }
